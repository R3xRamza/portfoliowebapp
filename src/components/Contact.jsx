    ...
    >
      ...
      >
        ...
        >
          ...
          <button
            type='submit'
            className='bg-white py-3 px-8 rounded-xl outline-none w-fit text-secondary font-bold text-[18px] hover:bg-secondary hover:text-white transition-all'
          >
